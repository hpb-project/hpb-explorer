...
import com.hpb.bc.solidity.abienum.SolidityTypeEnum;
...
//				}
    ...
    public static SolidityTypeEnum parseParameterToEnum(String str) {

        if (str.equals("int")) {
            return SolidityTypeEnum.INTEGER;
        } else if (str.equals("uint")) {
            return SolidityTypeEnum.UINTEGER;
        } else if (str.equals("bool")) {
            return SolidityTypeEnum.BOOL;
        } else if (str.equals("")) {
